...
For input that does not follow these rules, the decoder can be
configured to accept and normalize non-deterministic encodings,
including the indefinite-length forms from RFC 8949.
